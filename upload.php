...
// Si tout est ok, on upload le fichier
            ...
            if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
                ...
                $pdo = connectToBdd();
                $array = array();
                //TODO : ajouter le titre, puis construire un objet chiot pour le mettre dans le champs auteur
                $message = new Message($_POST["auteur"], $target_file, $array, $_POST['content_post'], date("Y-m-d"), 0, $_POST["txt_titre"]);
                addPost($pdo, $message);
